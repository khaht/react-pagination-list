...
var Main = React.memo(function (props) {
    ...
    return (React.createElement("div", { className: styles.kPagination },
        React.createElement("div", { className: styles.kPaginationListItem }, arrayList.map(function (item, key) { return props.renderItem(item, key); })),
        showListPaginate()));
});
Main.propTypes = {
